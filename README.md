...
1. Go to your [project’s API settings on manage.sanity.io](https://manage.sanity.io/projects/lgfaa1p8/settings/api) and create a token with read rights.
